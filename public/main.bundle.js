...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ngmaterial_module__ = __webpack_require__("./src/app/ngmaterial.module.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__components_todo_todo_component__ = __webpack_require__("./src/app/components/todo/todo.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__services_todo_service__ = __webpack_require__("./src/app/services/todo.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var appRoutes = [
    ...
    { path: 'auth/facebook', component: __WEBPACK_IMPORTED_MODULE_11__components_home_home_component__["a" /* HomeComponent */] },
    ...
    { path: 'todo', component: __WEBPACK_IMPORTED_MODULE_19__components_todo_todo_component__["a" /* TodoComponent */] }
];
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_19__components_todo_todo_component__["a" /* TodoComponent */]
            ],
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_6__ngmaterial_module__["a" /* MyOwnCustomMaterialModule */]
            ],
            providers: [
...
module.exports = "<h2 class=\"page-header\">Dashboard</h2>\n<p>Welcome to your Dashboard</p>\n<div class=\"container\">\n    <a class=\"waves-effect waves-light btn orange\" [routerLink]=\"['/todo']\" ><i class=\"material-icons left\">local_offer</i>Go to Todo</a>\n    <ul class=\"collection\">\n        <li class=\"collection-item avatar hoverable\" *ngFor=\"let message of messages\">\n            <i class=\"material-icons circle\">folder</i>\n            <p>{{message}}</p>\n        </li>\n    </ul>\n    <form (submit)=\"sendMsg()\">\n        <input type=\"text\" name=\"message\" [(ngModel)]=\"message\" id=\"message\">\n        <input class=\"btn btn-lg btn-primary\" type=\"submit\" value=\"Send Message\">\n    </form>\n</div>"
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(socketService, authService) {
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        ...
        this.socketService.receiveMessage().subscribe(function (msg) {
            _this.messages.push(msg);
        });
    };
    DashboardComponent.prototype.sendMsg = function () {
...
module.exports = "<h2 class=\"page-header\" >Login</h2>\n<form class=\"form-signin\" (submit)=\"onLoginSubmit()\">\n        <div class=\"form-group\">\n          <label for=\"Username\">Username</label>\n          <input type=\"text\" class=\"form-control\" placeholder=\"Enter Username\" [(ngModel)]=\"username\" name=\"username\">\n        </div>\n        <div class=\"form-group\">\n        <label for=\"Password\">Password</label>\n        <input type=\"password\" class=\"form-control\" placeholder=\" Enter Password\" [(ngModel)]=\"password\" name=\"password\">\n        </div>\n        <div class=\"checkbox\">\n          <label>\n            <input type=\"checkbox\" value=\"remember-me\"> Remember me\n          </label>\n        </div>\n        <input class=\"btn btn-lg btn-primary\" type=\"submit\" value=\"Login\">      \n</form>\n<br />\n<!-- <a class=\"waves-effect waves-light btn blue\" [routerLink]=\"['/users/facebook']\"><i class=\"material-icons left\">person_add</i>Login with Facebook</a> -->\n<!-- <a class=\"waves-effect waves-light btn orange\" (click)=\"onGoogleLogin()\" ><i class=\"material-icons left\">person_add</i>Login with Google</a> -->\n"
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(authService, validateService, socketService, router, flashMessage) {
        this.authService = authService;
    ...
    LoginComponent.prototype.onGoogleLogin = function () {
        var _this = this;
        this.authService.googlelogin().subscribe(function (data) {
            if (data.success) {
...
module.exports = "<nav>\n  <div class=\"nav-wrapper\">\n    <a class=\"brand-logo\">MEAN Auth App</a>\n    <ul class=\"right hide-on-med-and-down\">\n      <li [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\">\n        <a [routerLink]=\"['/']\"><i class=\"material-icons left\">home</i>Home<span></span></a>\n      </li>\n      <li class=\"nav-item\" *ngIf=\"this.authService.loggedIn()\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions] = \"{exact:true}\">\n        <a class=\"nav-link\" [routerLink]=\"['/dashboard']\"><i class=\"material-icons left\">dashboard</i>Dashboard </a>\n      </li>\n      <li class=\"nav-item\" *ngIf=\"this.authService.loggedIn()\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions] = \"{exact:true}\">\n        <a class=\"nav-link\" [routerLink]=\"['/profile']\"><i class=\"material-icons left\">face</i>Profile </a>\n      </li>\n      <li class=\"nav-item\" *ngIf=\"!this.authService.loggedIn()\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions] = \"{exact:true}\">\n        <a class=\"nav-link\" [routerLink]=\"['/login']\"><i class=\"material-icons left\">account_circle</i>Login </a>\n      </li>\n      <li class=\"nav-item\" *ngIf=\"!this.authService.loggedIn()\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions] = \"{exact:true}\">\n        <a class=\"nav-link\" [routerLink]=\"['/register']\"><i class=\"material-icons left\">account_box</i>Register</a>\n      </li>\n      <li class=\"nav-item\" *ngIf=\"this.authService.loggedIn()\"><a class=\"nav-link\" (click)=\"onLogoutClick()\" href=\"#\"><i class=\"material-icons left\">settings_power</i>Logout</a>\n      </li>\n    </ul>\n  </div>\n</nav>"
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(authService, socketService, router, flashMessage) {
        this.authService = authService;
        this.socketService = socketService;
        this.router = router;
        this.flashMessage = flashMessage;
...
module.exports = "<h2 class=\"page-header\">Register</h2>\n<form (submit)=\"onRegisterSubmit()\">\n  <div class=\"form-group\">\n    <label for=\"name\">Name</label>\n    <input type=\"text\" [(ngModel)]=\"name\" name=\"name\" id=\"name\" class=\"form-control\" placeholder=\"Enter Name\">\n  </div>\n  <div class=\"form-group\">\n    <label for=\"username\">Username</label>\n    <input type=\"text\" [(ngModel)]=\"username\" name=\"username\" id=\"username\" class=\"form-control\" placeholder=\"Enter Username\">\n  </div>\n  <div class=\"form-group\">\n    <label for=\"email\">Email</label>\n    <input type=\"text\" [(ngModel)]=\"email\" name=\"email\" id=\"email\" class=\"form-control\" placeholder=\"Enter Email\">\n  </div>\n  <div class=\"form-group\">\n    <label for=\"password\">Password</label>\n    <input type=\"password\" [(ngModel)]=\"password\" name=\"password\" id=\"password\" class=\"form-control\" placeholder=\"Enter Password\">\n  </div>\n  <input type=\"submit\" class=\"btn btn-primary\" value=\"Submit\">\n</form>\n"
...
module.exports = "<div class=\"row\">\n    <a class=\"waves-effect waves-light btn orange\" [routerLink]=\"['/dashboard']\" ><i class=\"material-icons left\">arrow_back</i>Go back</a>\n    <h2 class=\"header\">Your Clip Board</h2>\n    <div class=\"card horizontal scrollable\">\n      <div class=\"card-image\">\n  \n      </div>\n      <div class=\"card-stacked\">\n        <div class=\"card-content\">\n          <div *ngFor=\"let todo of todos\">\n            <div class=\"section\">\n              <h5>{{todo.value}}</h5>\n              <p>{{todo.time}}</p><p>{{todo._id}}</p>\n              <button class=\"btn waves-effect red\" (click)=\"deleteTodo(todo._id)\">\n                Remove<i class=\"material-icons\">delete</i>\n              </button>\n            </div>\n            <div class=\"divider\"></div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n<div class=\"row\">\n  <form class=\"col s12\" (submit)=\"addTodo()\">\n    <h2 class=\"header\">Todo</h2>\n    <div class=\"card horizontal\">\n      <div class=\"card-image\">\n\n      </div>\n      <div class=\"card-stacked\">\n        <div class=\"card-content\">\n          <div class=\"input-field col s12\">\n            <textarea id=\"todo\" class=\"materialize-textarea\" name=\"todo.value\" [(ngModel)]=\"todo.value\" data-length=\"120\"></textarea>\n            <label for=\"todo\">Add Note</label>\n          </div>\n        </div>\n        <div class=\"card-action\">\n          <button class=\"btn btn-primary waves-effect\" type=\"submit\">Clip it!</button>\n        </div>\n      </div>\n    </div>\n  </form>\n</div>\n"
...
var TodoComponent = /** @class */ (function () {
    function TodoComponent(todoservice, flashMessage) {
    ...
    TodoComponent.prototype.addTodo = function () {
        ...
        if (this.todo.value != '') {
            this.todoservice.addOneTodo(this.todo).subscribe(function (res) {
                _this.flashMessage.show('Added Note', { cssClass: 'alert-success', timeout: 5000 });
                _this.todoservice.getTodos().subscribe(function (todos) {
                    _this.todos = todos;
                });
            });
        }
    ...
    TodoComponent.prototype.deleteTodo = function (id) {
        var _this = this;
        this.todoservice.deleteTodo({ id: id }).subscribe(function (res) {
            _this.flashMessage.show('Deleted Note', { cssClass: 'alert-success', timeout: 5000 });
            _this.todoservice.getTodos().subscribe(function (todos) {
                _this.todos = todos;
            });
        });
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.registerUser = function (user) {
        ...
        return this.http.post(__WEBPACK_IMPORTED_MODULE_4__environments_environment__["a" /* environment */].URL + '/users/register', user, { headers: headers })
            .map(function (res) { return res.json(); });
    };
    AuthService.prototype.authenticateUser = function (user) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.http.post(__WEBPACK_IMPORTED_MODULE_4__environments_environment__["a" /* environment */].URL + '/users/login', user, { headers: headers })
            .map(function (res) { return res.json(); });
    };
    AuthService.prototype.getProfile = function () {
        ...
        headers.append('Content-Type', 'application/json');
        return this.http.get(__WEBPACK_IMPORTED_MODULE_4__environments_environment__["a" /* environment */].URL + '/users/profile', { headers: headers })
            .map(function (res) { return res.json(); });
    };
    ...
    AuthService.prototype.googlelogin = function () {
        ...
        return this.http.get(__WEBPACK_IMPORTED_MODULE_4__environments_environment__["a" /* environment */].URL + '/users/google', { headers: headers })
            .map(function (res) { return res.json(); });
    };
...
var SocketService = /** @class */ (function () {
    ...
    SocketService.prototype.initSocket = function (token) {
        this.socket = __WEBPACK_IMPORTED_MODULE_2_socket_io_client__(__WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].URL, {
    ...
    SocketService.prototype.receiveMessage = function () {
        var _this = this;
        return new __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["Observable"](function (observer) {
            _this.socket.on('Chat Message', function (data) { return observer.next(data); });
        });
    };
...
var TodoService = /** @class */ (function () {
    ...
    TodoService.prototype.addOneTodo = function (todo) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        this.authservice.loadToken();
        headers.append('Authorization', 'JWT ' + this.authservice.authToken);
        headers.append('Content-Type', 'application/json');
        return this.http.post(__WEBPACK_IMPORTED_MODULE_4__environments_environment__["a" /* environment */].URL + '/todos/add', todo, { headers: headers })
            .map(function (res) { return res.json(); });
    };
    TodoService.prototype.getTodos = function () {
        ...
        headers.append('Authorization', 'JWT ' + this.authservice.authToken);
        headers.append('Content-Type', 'application/json');
        return this.http.get(__WEBPACK_IMPORTED_MODULE_4__environments_environment__["a" /* environment */].URL + '/todos/get', { headers: headers })
            .map(function (res) { return res.json(); });
    };
    TodoService.prototype.deleteTodo = function (id) {
        ...
        headers.append('Authorization', 'JWT ' + this.authservice.authToken);
        headers.append('Content-Type', 'application/json');
        return this.http.post(__WEBPACK_IMPORTED_MODULE_4__environments_environment__["a" /* environment */].URL + '/todos/delete', id, { headers: headers })
            .map(function (res) { return res.json(); });
    };
...
var environment = {
    ...
    URL: 'https://skfiresystem.herokuapp.com'
};
